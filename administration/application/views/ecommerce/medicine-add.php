        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="block bg-trans table-block mb-4">
                    <?= form_open('add-medicine', array('class'=>'horizontal-form'));;?>
                        ...
                        <div class="form-group form-row">
                            ...
                            <select name="data[mfg]"" class="form-control col-md-10">
                                {pharmacy}
                                    <option value={pharma_id}>{pharma_name}</option>
                                {/pharmacy}
                            </select>    
                        ...
                        <div class="form-group form-row">
                            ...
                            <?=form_dropdown('data[packing_form]', $options, 'Strips' , array('class' => 'custom-select form-control col-md-4'));;?>
                            ...
                            <?=form_dropdown('data[form]', $options, 'Tablets' , array('class' => 'custom-select form-control col-md-4'));;?>
                        </div>    
                        <div class="form-group form-row">
                            ...
                            <?=form_input(
                                ...
                                ( 
                                    ...
                                    'value' => set_value('data[packing_qty]'), 
                                    'class' => 'form-control col-md-4', 
                                    'type'  => 'text',
                                    'required' => 'required',
                         ...
                         <div class="form-group form-row">
                            ...
                            <?=form_input(
                                ...
                                ( 
                                    ...
                                    'value' => set_value('data[max_discount]'), 
                                    'class' => 'form-control col-md-4', 
                                    'type'  => 'text',
                                    'required' => 'required',
