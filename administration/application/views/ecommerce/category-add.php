...
<?= form_open_multipart(site_url('add-category'), array('class'=>'horizontal-form'));;?>
<div class="content sm-gutter">
    <div class="container-fluid padding-25 sm-padding-10">
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    <h4><i class="dripicons-network-3"></i> CREATE CATEGORY
                ...
                <div class="block bg-trans table-block mb-4">
                	<div class="form-group form-row">
                        <?php 
							...
							foreach($categories as $key=>$value): extract($value);
								$options[$category_id] = $category_name;
							endforeach;	
						?>
                        <?=form_label('Parent Category','data[parent]',array('class'=>'col-md-2'));?>
                        <?=form_dropdown('data[parent]', $options, 0 , array('class' => 'custom-select form-control col-md-10'));;?>
                    </div>    
                    <div class="form-group form-row">
