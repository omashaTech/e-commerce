            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="block bg-trans table-block mb-4">
                        <?= form_open_multipart(site_url("update-pharma/$pharma_id"), array('class'=>'horizontal-form'));;?> 
                            <div class="form-group form-row">
                                ...
                                <?=form_input(
                                    ...
                                    ( 
                                        'name'  => 'data[name]', 
                                        'value' => set_value('data[name]',$pharma_name), 
                            ...
                            <div class="form-group form-row">
                                ...
                                <?=form_dropdown('data[status]', $options, $pharma_status, array('class' => 'custom-select form-control col-md-10'));;?>
                                <div class="clearfix"> </div>
                            </div>         
                            <div class="form-group form-row">
